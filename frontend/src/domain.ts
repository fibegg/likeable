...
export type Me = { user: User | null; isAdmin?: boolean; messageQuota?: MessageQuota; projectQuota?: ProjectQuota; notices?: UserNotice[]; auth?: { googleConfigured: boolean; devAuth: boolean } };
