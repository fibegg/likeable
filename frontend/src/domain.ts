...
export type AdminProjectInternal = { userId: string; conversationId?: string; agentId?: string; serverId?: string; playgroundId?: string; playgroundName?: string; playspecId?: string; propId?: string; repoUrl?: string; provisioningLockUntil?: string; cleanupLastError?: string };
