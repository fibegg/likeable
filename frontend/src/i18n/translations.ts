...
- Contact support from Profile with questions, correction requests, deletion requests, or requests for a copy of your data.
  ...
  'projects.production.domainActive': 'DNS verified · routing active',
  ...
  'admin.readiness.body': 'Production blockers across Stripe, Fibe runtime, OAuth, support mail, and access policy.',
  ...
  'admin.readiness.noIssues': 'Production launch checks are clear.',
  ...
  'admin.readiness.check.productionProjectPrice': 'Stripe production-project price',
  'admin.readiness.check.fibeTemplate': 'Fibe template version',
...
- Звернення в підтримку з Профілю щодо питань, виправлення, видалення або отримання копії даних.
  ...
  'projects.production.domainActive': 'DNS перевірено · маршрутизація активна',
  ...
  'admin.readiness.body': 'Production блокери у Stripe, Fibe runtime, OAuth, пошті підтримки та політиці доступу.',
  ...
  'admin.readiness.noIssues': 'Production перевірки запуску чисті.',
  ...
  'admin.readiness.check.productionProjectPrice': 'Stripe price для production проєкту',
  'admin.readiness.check.fibeTemplate': 'Версія Fibe template',
