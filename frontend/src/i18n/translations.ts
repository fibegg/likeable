...
- Contact support from Profile with questions, correction requests, deletion requests, or requests for a copy of your data.
  ...
  'onboarding.slide.messagesBulletThree': 'Improve Prompt can use build minutes when prompt improvement charging is enabled.',
...
- Звернення в підтримку з Профілю щодо питань, виправлення, видалення або отримання копії даних.
  ...
  'onboarding.slide.messagesBulletThree': 'Improve Prompt може використовувати хвилини збірки, якщо списання за покращення запиту увімкнене.',
