const en = {
  ...
  'builder.agent.noActivity': 'No build activity yet. Check the Fibe agent/provider key, then try again.',
...
const uk: Record<keyof typeof en, string> = {
  ...
  'builder.agent.noActivity': 'Активності build agent ще немає. Перевірте Fibe agent/provider key і спробуйте знову.',
