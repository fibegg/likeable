const en = {
  ...
  'builder.preview.stoppedBody': 'Likeable stopped this playground due to inactivity. Start it from the project menu when you need it again.',
...
const uk: Record<keyof typeof en, string> = {
  ...
  'builder.preview.stoppedBody': 'Likeable зупинив цей плейграунд, щоб зберегти ресурси. Запустіть його з меню проєкту, коли він знову знадобиться.',
