...
export const ADMIN_CONFIG_SECTIONS = [
  ...
  },
  {
    ...
    keys: ['fibe_template_version_id', 'free_hours', 'free_hour_window_hours', 'project_cap', 'agent_artefacts', 'smtp_host', 'smtp_port', 'smtp_username', 'smtp_password', 'smtp_from_email', 'smtp_from_name', 'smtp_tls_mode']
  }
];
